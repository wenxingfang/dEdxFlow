...
class StandardNormal(Distribution):
    ...
    def _sample(self, num_samples, context):
        ...
        if context is None:
            ...
            #print('StandardNormal:_sample, samples=',samples)
            #print('StandardNormal: final sample=', torchutils.split_leading_dim(samples, [context_size, num_samples] ) )
